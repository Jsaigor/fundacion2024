...
function clases(){ ?>
      <div class="btn-group" role="group" aria-label="Clases">
        ...
        <a href="https://drive.google.com/file/d/1G0tHU-jHhDGLwYPBN8Ld8M2E_WPKQ-KI/view?usp=drive_link" class="btn btn-primary" role="button" target="_blank">Clase 6</a>
        <a href="https://drive.google.com/file/d/1B2AvjwVnug6Y_DJWUYnHiWtLMomCMcDh/view?usp=drive_link" class="btn btn-primary" role="button" target="_blank">Clase 7</a>
        <a href="https://drive.google.com/file/d/1o6PpcR__hZlqMQcT-eEtoPTPCBkLJeSb/view?usp=drive_link" class="btn btn-primary" role="button" target="_blank">Clase 8</a>
        <div class="btn-group">
        <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            TP Final
          </button>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="TP final Módulo 1.pdf" target="_blank">TP Final</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="tp1Ej1.txt" target="_blank">tp1Ej1</a></li>
            <li><a class="dropdown-item" href="tp1Ej2.txt" target="_blank">tp1Ej2</a></li>
            <li><a class="dropdown-item" href="unnro.txt" target="_blank">Función<nav></nav></a></li>
          </ul>
        </div>
      </div>
